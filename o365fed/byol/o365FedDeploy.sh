...
curl -k -f --retry 5 --retry-delay 10 --retry-max-time 10 -o /config/o365FedCert.pfx $certificate_location
...
for template in f5.microsoft_office_365_idp.v1.2.0rc1.tmpl
do
